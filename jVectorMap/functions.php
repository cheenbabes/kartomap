...
function load_map_scripts(){
	wp_register_script( 'raphael', get_template_directory_uri() . '/raphael-min.js');
	wp_register_script( 'kartograph', get_template_directory_uri() . '/kartograph.min.js');
	wp_register_script( 'qtip', get_template_directory_uri() . '/jquery.qtip.min.js');
	wp_register_script( 'custom_map', get_template_directory_uri() . '/custom-map-scripts.js');
	wp_register_script( 'jvector', get_template_directory_uri() . '/jquery-jvectormap-2.0.2.min.js');
	wp_register_script( 'jvector_custom', get_template_directory_uri() . '/jvector-custom.js');
	wp_enqueue_script('raphael');
	wp_enqueue_script('kartograph');
	wp_enqueue_script('qtip');
	wp_enqueue_script('custom_map');
	wp_enqueue_script('jvector');
	wp_enqueue_script('jvector_custom');
	
}

add_action('wp_enqueue_scripts', 'load_map_scripts');

function load_map_styles(){
	wp_register_style('qTipStyle', get_template_directory_uri() . '/jquery.qtip.min.css');
	wp_register_style('jvectorStyle', get_template_directory_uri() . '/jquery-jvectormap-2.0.2.css');

	wp_enqueue_style('qTipStyle');
	wp_enqueue_style('jvectorStyle');
}

add_action('wp_enqueue_scripts', 'load_map_styles');